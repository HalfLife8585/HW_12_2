...
class Purchase:
    ...
    def add_item(self, item, cnt):
        if item in self.products:
            self.products[item] = cnt  # Оновлюємо кількість, якщо товар вже є
        else:
            self.products[item] = cnt
        self.calculate_total()  # Перераховуємо загальну суму після кожного додавання
...
# Створення екземплярів та тестування
